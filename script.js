...
const localizedNodes = [
  ...
  { selector: ".portfolio-proof-section .section-kicker", text: { en: "Selected Public Materials", zh: "精选公开材料" } },
  { selector: ".portfolio-proof-section h2", text: { en: "Public artifacts from founder-led product, community, and AI workflow projects.", zh: "来自产品、社群与 AI 工作流项目的公开材料。" } },
  {
    selector: ".portfolio-proof-section .section-intro",
    text: {
      en: "Launched products, project pages, videos, and public metrics that show how I turn product ideas into adoption, community activation, user education, and commercial narratives.",
      zh: "上线产品、项目页面、视频和公开数据，展示我如何把产品想法转化为采用、社群激活、用户教育和商业叙事。",
    },
  },
  ...
  { selector: ".portfolio-proof-grid article:nth-child(1) .proof-note", text: { en: "Business plan, campaign materials, and demo assets", zh: "商业计划、营销材料和 Demo 资料" } },
  ...
  { selector: ".portfolio-proof-grid article:nth-child(2) .proof-note", text: { en: "Xiaohongshu and offline activation materials", zh: "小红书与线下激活材料" } },
  ...
  { selector: ".portfolio-proof-grid article:nth-child(3) .proof-note", text: { en: "Business plan and award materials", zh: "商业计划和奖项材料" } },
  ...
  { selector: "#credentials .section-kicker", text: { en: "Credentials", zh: "权威背书" } },
  { selector: "#credentials h2", text: { en: "Entrepreneurship awards, IP, public platforms, and commercial experience.", zh: "创业奖项、知识产权、公开平台影响力与商业化经历。" } },
  {
    selector: "#credentials .section-intro",
    text: {
      en: "Additional evidence across national competitions, research and IP, public content platforms, and agency/client work.",
      zh: "国家级赛事、科研与知识产权、公开内容平台和代理商/客户服务经历，共同构成可验证的长期能力背景。",
    },
  },
  ...
  { selector: ".credential-grid article:nth-child(4) p", text: { en: "4A agency experience supporting enterprise clients including Weichai Power and Sinotruk; additional market, content, and commercial operations experience across YAMI, HungryPanda, Wanda, Hengdian, and Sohu.", zh: "具备 4A 代理商经验，服务过潍柴动力、中国重汽等企业客户；同时具备 YAMI、HungryPanda、万达、横店、搜狐等市场、内容和商业运营经历。" } },
